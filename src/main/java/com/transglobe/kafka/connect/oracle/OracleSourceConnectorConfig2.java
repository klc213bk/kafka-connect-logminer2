...
public class OracleSourceConnectorConfig2 extends AbstractConfig {
  ...
  public static final String USING_CM = "using.cm";
  public static final String HEARTBEAT_TABLE = "heartbeat.table";
  public static final String LOGMINER_CLIENT = "logminer.client";
  
  public OracleSourceConnectorConfig2(ConfigDef config, Map<String, String> parsedConfig) {
    super(config, parsedConfig);
  }

  public OracleSourceConnectorConfig2(Map<String, String> parsedConfig) {
  ...
  public static ConfigDef conf() {
    return new ConfigDef()
        ...
        .define(USING_CM, Type.BOOLEAN, Importance.HIGH, "If Using Continuous Mine")
        .define(HEARTBEAT_TABLE, Type.STRING, Importance.HIGH, "heartbeat table")
        .define(LOGMINER_CLIENT, Type.STRING, Importance.HIGH, "logminer client");
  ...
  public Boolean getUsingCm() {return this.getBoolean(USING_CM); }
  public String getHeartbeatTable(){return this.getString(HEARTBEAT_TABLE);}
  public String getLogminerClient(){return this.getString(LOGMINER_CLIENT);}
}
