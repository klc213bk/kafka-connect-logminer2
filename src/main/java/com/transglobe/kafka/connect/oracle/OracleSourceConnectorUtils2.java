...
public class OracleSourceConnectorUtils2{
    static final Logger log = LoggerFactory.getLogger(OracleSourceConnectorUtils2.class);
    private String logMinerSelectWhereStmt;
    private String tableWhiteList;
    private String tableBlackList;
    private String logMinerSelectSql = OracleConnectorSQL2.LOGMINER_SELECT_WITHSCHEMA;
    private String logMinerSelectSqlDeSupportCM = OracleConnectorSQL2.LOGMINER_SELECT_WITHSCHEMA_DESUPPORT_CM;
    ...
    OracleSourceConnectorConfig2 config;
    Connection dbConn;
    ...
    public OracleSourceConnectorUtils2(Connection Conn,OracleSourceConnectorConfig2 Config)throws SQLException {    	
        this.dbConn=Conn;
        this.config=Config;
        parseTableWhiteList();
    }
    ...
    protected int getDbVersion() throws SQLException{
      int dbVersion = 0;
      PreparedStatement dbVersionPs = dbConn.prepareCall(OracleConnectorSQL2.DB_VERSION);
    ...
    protected void loadTable(String owner,String tableName,String operation) throws SQLException{
      ...
      String mineTableColsSql=OracleConnectorSQL2.TABLE_WITH_COLS;
      if (config.getMultitenant()){
        mineTableColsSql=OracleConnectorSQL2.TABLE_WITH_COLS_CDB;
      }
